  ...
  private
    ...
    def lesson_params
      params.require(:lesson).permit(
        :order, :title, :project_id, :synopsis, :overview, :objective, :setting_up, :materials, :first_photocopy, :second_photocopy, :third_photocopy, :media, :example_image, :inspiration_image, :inspiration_image_title,
