class Admin::ProjectsController < ApplicationController
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:overview, :synopsis, :materials, :materials_suggestion, :books_media, :photocopy, :first_photocopy, :second_photocopy, :third_photocopy, :photocopy_copyright, :common_core, :national_core, :art_elements, :art_principles, :cross_curricular, :inspiration_image, :featured_artist_image, :featured_artist_description, sections_attributes: [:id, :order, :content])
    end
end
