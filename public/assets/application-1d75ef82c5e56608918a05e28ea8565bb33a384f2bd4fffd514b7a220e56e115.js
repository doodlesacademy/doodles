...
(function() {
  (function($, window) {
    return $(function() {
      ...
      $('#pencil-classroom').click(function() {
      ...
      $('#pencil-password').click(function() {
        $('#edit-password').toggle();
      });
      $('#camera-icon').click(function() {
        $('#user_profile_attributes_avatar').trigger('click');
      });
      return $('#user_profile_attributes_avatar').change(function() {
...
(function() {
  (function($, window) {
    return $(function() {
      var $body, $close_btn, $document, $dropdown_content, $email, $email_input, $footerSubmit, $lightbox, $message, $nav, $newsletter, $parallax, $parallax_height, $parallax_offset, $quote, $submit, $window, VIDEO_EMBED, closeOnEscape, closeVideo, dataType, emailErrorMessage, emailRegex, gal_images, getUrlVars, handleEmailSubmission, hasValue, img_number, invalidEmailMsg, left_gal_img, lightbox_template, navHeight, nextQuote, onScroll, quotePersons, quote_number, quotes, right_gal_img, scrollClass, showVideo, submitted, text, url;
      $document = $(document);
      $nav = $('.doodles-nav');
      ...
      quotePersons = ['Kara Bloom', 'Laura Harris', 'Erin Scott', 'Julie Rains'];
      quote_number = 0;
      ...
      $email_input.on('keyup keydown', _.debounce(function(e) {
        if (e.which === 13) {
      ...
      return $('.collapsible').click(function() {
        var theId;
        theId = $(this).attr('id');
...
(function() {
  (function($, window) {
    return $(function() {
      var a, aLink, aText, aTextFinal, afterSlash, appendInspirationImage, appendVimeoVideo, beforeSlash, headToc, headingClass, idText, lessonHeadings, lessonSubheadings, mainHeading, n, numHead, numOfh1, results, s, setupListeners, thisA, thisHead, toTitleCase, y;
      ...
      while (n < numOfh1) {
        ...
        $(window).on('scroll', function() {
          var $distance, extensionDistance, lessonDistance, lessonFinishedDistance, o, overviewDistance, scrollTop;
        ...
        results.push($('#lesson-sidebar div p p a').click(function() {
  ...
  (function($, window) {
    return $(function() {
      ...
      setupListeners = function() {
        ...
        return $('.project-grid').off().on('click', '.project-grid-item', selectProject);
      };
      selectProject = function(e) {
        var $project, favorite_lower, favorite_upper, handleFavorite, lower_project_id, project_featured_image, project_id, project_synopsis, project_title, unit_full_title, upper_project_id;
        ...
        handleFavorite = function(level, level_project_id, favorite_or_unfavorite) {
          return $('.save-project-' + level).off().on('click', function() {
            var iteration;
